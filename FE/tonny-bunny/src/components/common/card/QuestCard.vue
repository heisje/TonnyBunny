            ...
            <div class="questCard">
                ...
                <div class="questProfile mt-3">
                    <div class="profile ms-3">
                        <UserProfileImg
                            class="profileImg"
                            :profileImagePath="questDetail?.client?.imagePath" />
                        <div class="userType ms-3">
                    ...
                    <div class="profile me-3">
                        <div class="userType">
                            <span class="label text-right me-2">헬퍼</span>
                            <h4 class="overflow text-right" v-if="questDetail?.helper?.nickName">
                                {{ questDetail?.helper?.nickName }}
                            </h4>
                            <h4 class="overflow text-right" v-else>미지정</h4>
                        </div>
                        <UserProfileImg
                            class="profileImg ms-3"
                            :profileImagePath="questDetail?.helper?.imagePath" />
                    </div>
                </div>
                ...
                <div class="questInfo">
                    <div class="infoDesc mb-4">
                        ...
                        <div class="sub" style="font-size: 0.9rem">{{ questDetail?.content }}</div>
                    </div>
