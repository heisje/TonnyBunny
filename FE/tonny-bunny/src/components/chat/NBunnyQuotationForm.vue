<template lang="">
    <div class="d-flex justify-content-center customFormWrap w-100">
        <form class="customForm" @submit.prevent="submitForm(event)">
            ...
            <title-text type="h2" title="언어 선택" bottom="20" />
            ...
            <div class="w120">
                <input type="date" @input="changeInput" placeholder="시작일 마감일 선택" />
            </div>
            ...
            <div class="d-flex">
                <div class="w-100">
                    <input type="text" @input="changeInput" class="w-100" placeholder="ex)1000" />
                </div>
                <div class="backlabel">
                    <h3>CRT</h3>
                </div>
