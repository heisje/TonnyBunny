...
@Service
public class AlertAcceptSubscriber implements MessageListener {
	...
	public void onMessage(Message message, byte[] pattern) {
		try {
			...
			String url;
			url = "/sub/alert/accept/" + alertLogRequestDto.getClientSeq();
			template.convertAndSend(url, alertLogRequestDto);

			url = "/sub/alert/accept/" + alertLogRequestDto.getHelperSeq();
			template.convertAndSend(url, alertLogRequestDto);
