...
@Service
public class AlertRejectSubscriber implements MessageListener {
	...
	public void onMessage(Message message, byte[] pattern) {
		try {
			...
			String url;
			url = "/sub/alert/reject/" + alertLogRequestDto.getClientSeq();
			template.convertAndSend(url, alertLogRequestDto);

			url = "/sub/alert/reject/" + alertLogRequestDto.getHelperSeq();
			template.convertAndSend(url, alertLogRequestDto);
