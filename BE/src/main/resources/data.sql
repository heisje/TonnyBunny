...
VALUES (1, now(), now(), "client1@ssafy.com", true, false, "최유저",
        "$2a$10$IGu.pRd5Kn50eRFxcsZ1/O1i3guAooijPw9/SXurzZDuta2VN9ixK", "010", 1000, "image", 0, "0010001"),
       (2, now(), now(), "client2@ssafy.com", true, false, "안유저",
        "$2a$10$IGu.pRd5Kn50eRFxcsZ1/O1i3guAooijPw9/SXurzZDuta2VN9ixK", "010", 2000, "image2", 0, "0010001"),
       (3, now(), now(), "client3@ssafy.com", true, false, "강유저",
        "$2a$10$IGu.pRd5Kn50eRFxcsZ1/O1i3guAooijPw9/SXurzZDuta2VN9ixK", "010", 3000, "image", 0, "0010001"),
       (4, now(), now(), "helper1@ssafy.com", true, false, "김헬퍼",
        "$2a$10$IGu.pRd5Kn50eRFxcsZ1/O1i3guAooijPw9/SXurzZDuta2VN9ixK", "010", 4000, "image", 0, "0010002"),
       ...
       (8, now(), now(), "clientzzang@ssafy.com", true, false, "동준갓",
        "$2a$10$7.RTTHBcOgE/8KVNyRNfk.OEMuDu8VhlimMhk.7H6Sel2UsryCmau", "010", 0, "image", 0, "0010001"),
       (9, now(), now(), "helperzzang@ssafy.com", true, false, "효은갓",
        "$2a$10$7.RTTHBcOgE/8KVNyRNfk.OEMuDu8VhlimMhk.7H6Sel2UsryCmau", "010", 0, "image", 0, "0010002");
...
VALUES (1, 4, 5000, "안녕하세요. 김헬퍼입니다.", "안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.", 2, 6, now(), now()),
       ...
       (5, 9, 1000000, "안녕하세요. 부울경 실습코치입니다.", "안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.", 0, 0, now(), now());
