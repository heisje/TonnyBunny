...
VALUES (1, 4, 500, "안녕하세요. 김헬퍼입니다.", "안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.", 2, 7, now(), now()),
       (2, 5, 400, "안녕하세요. 나헬퍼입니다.", "안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.", 0, 0, now(), now()),
       (3, 6, 100, "안녕하세요. 박헬퍼입니다.", "안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.", 0, 0, now(), now()),
       (4, 7, 1000, "안녕하세요. 이헬퍼입니다.", "안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.", 0, 0, now(), now()),
       (5, 9, 2000, "안녕하세요. 부울경 실습코치입니다.", "안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.안녕하세요.", 0, 0, now(), now());
...
VALUES (1, 1, 0, "sdoiefsigxdsgssdfjq", "0030002", "0020001", "0020002", "0040004", "철강회사 바이어 미팅건",
       ...
       (3, 3, 0, "sdoiefsigxdgdfgljaesgs", "0030002", "0020001", "0020000", "0040001", "관공서 서류 작업 예정",
        "어쩌고 저쩌고 작업 가능하신 분을 찾습니다.", 30000, "01:00", "0090001", "2023-02-14 00:00:00", false, now(), now());
